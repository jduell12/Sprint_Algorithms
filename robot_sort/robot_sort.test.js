...
describe('SortingRobot', ()=>{
    ...
    it('[1] works with small list', ()=>{
        const robot = new SortingRobot(small)
        robot.sort();
        expect(robot.list).toEqual([1, 2, 3, 4, 5])
    })
    
    it('[2] works with med list', ()=>{
        const robot = new SortingRobot(med)
        robot.sort();
    ...
    it('[3] works with large list', ()=>{
        const robot = new SortingRobot(large)
        robot.sort();
        expect(robot.list).toEqual([
    ...
    it('[4] works with large varied list', ()=>{
        const robot = new SortingRobot(varied)
        robot.sort();
        expect(robot.list).toEqual([
            -100, -98, -95, -95, -88, -88, -87, -87, -85, -81, -81, -79,
            -78, -77, -76, -74, -73, -73, -69, -65, -65, -64, -59, -57,
            -57, -57, -55, -53, -51, -47, -47, -47, -41, -40, -38, -37,
            -36, -36, -35, -35, -35, -31, -26, -24, -23, -18, -18,  -3,
             -2,  -2,   1,   1,   2,   4,  11,  13,  14,  15,  21,  21,
             21,  22,  23,  24,  25,  25,  26,  29,  36,  37,  38,  39,
